...
/**
 * Classe che implementa il filtraggio della lingua DE e della locazione DE su i tweet.
 * @author Ricciardi Nicola
 * @author Rendina Michele Pio
 */
public class FilterDE_DE implements Filters<Object, Object>
{
	/**
	...
	/**
	 * Costruttore della classe FilterDE_DE.
	 * @param array Array di tweet.
	 */
	public FilterDE_DE(JSONArray array)
	{
		super();
